 ...
 * @date 2019/1/6
 */
public class FixedDishLayoutManager3 extends RecyclerView.LayoutManager {
    ...
    public FixedDishLayoutManager3(Context context) {
        this(context, 5000);
    }

    public FixedDishLayoutManager3(Context context, int initPosition) {
...
//        int distance = (position-currrentPosition)*halfItemWidth;
    ...
    private void brewAndStartAnimator(int dur, int finalXorY) {
        animator = ObjectAnimator.ofInt(FixedDishLayoutManager3.this, "animateValue", 0, finalXorY);
